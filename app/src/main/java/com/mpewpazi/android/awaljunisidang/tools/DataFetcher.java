...
import com.mpewpazi.android.awaljunisidang.modelExtras.PeriodeSurvey;
...
import com.mpewpazi.android.awaljunisidang.modelExtras.SurveyAssignSurveyor;
import com.mpewpazi.android.awaljunisidang.modelExtras.User;
...
public class DataFetcher {
    ...
    public static final Uri FGFotoENDPOINT = Uri.parse("http://192.168.1.100/galpal/f1FotoGalangan/api/id");
    ...
    public Perusahaan fetchPerusahaan(String idPerusahaan){
        ...
        try {
            ...
            Log.i(TAG, "FetchPerusahaan: " + jsonPerusahaanString);
    ...
    public KualifikasiSurvey fetchKualifikasiSurvey(String idKualifikasiSurvey){
        ...
        try {
            ...
            Log.i(TAG, "FetchKualifikasiSurvey: " + jsonKualifikasiSurveyString);
    ...
    public List<SingleForm> fetchFormGalpals(String idKualifikasiSurvey) {
        ...
        String uriFormGalpalFoto=buildUrl(FGFotoENDPOINT,idKualifikasiSurvey);
        ...
        try {
           ...
           Log.i(TAG, "FetchFG1: " + jsonFormGalpal1String);
           Log.i(TAG, "FetchFG3: " + jsonFormGalpal3String);
           //Log.i(TAG, "FetchFG4: " + jsonFormGalpal4String);
            Log.i(TAG, "FetchFG6: " + jsonFormGalpal6String);
            Log.i(TAG, "FetchFG7: " + jsonFormGalpal7String);
            Log.i(TAG, "FetchFG8: " + jsonFormGalpal8String);
            Log.i(TAG, "FetchFG9: " + jsonFormGalpal9String);
            Log.i(TAG, "FetchFG10: " + jsonFormGalpal10String);
            Log.i(TAG, "FetchFG11: " + jsonFormGalpal11String);
            Log.i(TAG, "FetchFGFOTO: " + jsonFormGalpalFotoString);
           ...
           // parseFormGalpal4(items,jsonFormGalpal4Body);
            ...
            parseFormGalpalFotos(items,jsonFormGalpalFotoBody);
    ...
    public List<SingleForm> fetchFormKompals(String idKualifikasiSurvey) {
        ...
        try {
            ...
            Log.i(TAG, "FetchFK3A: " + jsonFormKompal3aString);
            Log.i(TAG, "FetchFK3B: " + jsonFormKompal3bString);
            Log.i(TAG, "FetchFK3C: " + jsonFormKompal3cString);
            Log.i(TAG, "FetchFK3D: " + jsonFormKompal3dString);
    ...
    public void fetchFormLastInsert(SingleForm singleForm,Uri ENDPOINT,String formServerIdNameCols) {
        ...
        try {
            ...
            JSONObject jsonObject = jsonFormBody.getJSONObject((jsonFormBody.length())-1);
            singleForm.setFormServerId(jsonObject.getInt(formServerIdNameCols));
    ...
    public void fetchModifyDate(SingleForm singleForm,Uri ENDPOINT,String formServerIdNameCols) {
        String idKualifikasiSurvey=String.valueOf(singleForm.getKualifikasiSurveyId());
        String uriForm=buildUrl(ENDPOINT,idKualifikasiSurvey);
        ...
        try {
            ...
            for(int x=0;x<jsonFormBody.length();x++){
                JSONObject jsonObject = jsonFormBody.getJSONObject(x);
                if(jsonObject.getInt(formServerIdNameCols)==singleForm.getFormServerId()){
                    singleForm.setModifyDate(jsonObject.getString(FK3dStandarMutuTableTable.Cols.MODIFIED_DATE));
                    //Log.i(TAG, "Modify Date: " + jsonObject.getString(FK3dStandarMutuTableTable.Cols.MODIFIED_DATE));
                }
            }
        } catch (JSONException je){
            Log.e(TAG, "Failed to parse JSON", je);
    ...
    private void parseFormGalpalFotos(List<SingleForm> items, JSONArray jsonBody) throws IOException, JSONException, ParseException {
        ...
        for (int i = 0; i < jsonBody.length(); i++) {
            JSONObject jsonObject = jsonBody.getJSONObject(i);
            FormGalpalFoto item = new FormGalpalFoto();
            item.setFormServerId(jsonObject.getInt(FormGalpalFotoTable.Cols.ID_F1_FOTO_GALANGAN_SERVER));
            item.setKualifikasiSurveyId(jsonObject.getInt(FormGalpalFotoTable.Cols.ID_KUALIFIKASI_SURVEY));
            item.setIdPeriode(jsonObject.getInt(FormGalpalFotoTable.Cols.ID_PERIODE));
            item.setNamaFoto(jsonObject.getString(FormGalpalFotoTable.Cols.NAMA_FOTO));
            item.setFotoGalangan(jsonObject.getString(FormGalpalFotoTable.Cols.FOTO_GALANGAN));
    ...
    public List<Notification> fetchNotifications(String userid) {
        ...
        String uriNotification=buildUrl(NotificationENDPOINT,userid);
        try {

            String jsonNotificationString = getUrlString(uriNotification);
            Log.i(TAG, "Received JSON: " + jsonNotificationString);

            JSONArray jsonNotificationBody = new JSONArray(jsonNotificationString);
            parseNotifications(items,jsonNotificationBody);
    ...
    private void parseNotifications(List<Notification> items, JSONArray jsonBody) throws IOException, JSONException, ParseException {
        for (int i = 0; i < jsonBody.length(); i++) {
            JSONObject jsonObject = jsonBody.getJSONObject(i);
            ...
            item.setNotifyStatus(jsonObject.getString(NotificationTable.Cols.NOTIF_STATUS));
            Log.i(TAG,jsonObject.getString(NotificationTable.Cols.NOTIF_STATUS));
