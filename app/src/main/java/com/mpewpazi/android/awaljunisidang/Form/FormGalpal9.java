 ...
 */
public class FormGalpal9 extends SingleForm {
    private UUID idPeralatanKerjaProduksiKontruksi;
    ...
    public SingleFragment getFragment() {
        return new ListFormGalpal9Fragment();
    }

    @Override
    public String getNamaForm() {
        return "Peralatan Kerja Produksi Kontruksi";
    }
    ...
    public FormGalpal9(UUID id){
        idPeralatanKerjaProduksiKontruksi=id;
    }
    ...
    public UUID getIdPeralatanKerjaProduksiKontruksi() {
        return idPeralatanKerjaProduksiKontruksi;
    }
