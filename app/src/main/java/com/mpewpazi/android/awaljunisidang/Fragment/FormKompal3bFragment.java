 ...
 */
public class FormKompal3bFragment extends SingleFragment implements Validator.ValidationListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMenuCheckingKompal=DummyMaker.get(getActivity()).getMenuCheckingKompal(kualifikasiSurveyId,mFormKompal3b.getKodeForm());
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        setViewNote(mKualifikasiSurvey,mFormKompal3b);
    }
