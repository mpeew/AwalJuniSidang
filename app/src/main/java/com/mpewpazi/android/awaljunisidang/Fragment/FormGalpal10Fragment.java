 ...
 */
public class FormGalpal10Fragment extends SingleFragment implements Validator.ValidationListener {
    private static final String ARG_FORMGALPAL10_ID="formgalpal10_id";
    private static final String ARG_FORMGALPAL10_KUALIFIKASI_SURVEY_ID="formgalpal10_kualifikasi_id";
    ...
    public static FormGalpal10Fragment newInstance(UUID id, int kualifikasiSurveyId){
        //bundle itu berisi key-value fair seperti intent

        //bundle tidak jauh seperti intent penggunannya
        Bundle args=new Bundle();
        args.putSerializable(ARG_FORMGALPAL10_ID, id);
        args.putInt(ARG_FORMGALPAL10_KUALIFIKASI_SURVEY_ID, kualifikasiSurveyId);

        FormGalpal10Fragment fragment=new FormGalpal10Fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //sementara
        int kualifikasiSurveyId=getArguments().getInt(ARG_FORMGALPAL10_KUALIFIKASI_SURVEY_ID);
        UUID formGalpal10Id=(UUID)getArguments().getSerializable(ARG_FORMGALPAL10_ID);

        mKualifikasiSurvey= DummyMaker.get(getActivity()).getKualifikasiSurvey(kualifikasiSurveyId);
        mFormGalpal10= DummyMaker.get(getActivity()).getFormGalpal10(formGalpal10Id);
        mMenuCheckingGalpal=DummyMaker.get(getActivity()).getMenuCheckingGalpal(kualifikasiSurveyId,mFormGalpal10.getKodeForm());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mJenisMesinEditText.setText(mFormGalpal10.getJenisMesin());
        mJenisMesinEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setJenisMesin(s.toString());
            }
        ...
        mTahunPembuatanEditText.setText(String.valueOf(mFormGalpal10.getTahunPembuatan()));
        mTahunPembuatanEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setTahunPembuatan(convertToInt(s.toString()));
            }
        ...
        mMerekEditText.setText(mFormGalpal10.getMerek());
        mMerekEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setMerek(s.toString());
            }
        ...
        mKapasitasTerpasangEditText.setText(String.valueOf(mFormGalpal10.getKapasitasTerpasang()));
        mKapasitasTerpasangEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setKapasitasTerpasang(convertToInt(s.toString()));
            }
        ...
        mDimensiEditText.setText(mFormGalpal10.getDimensi());
        mDimensiEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setDimensi(s.toString());
            }
        ...
        mJumlahEditText.setText(String.valueOf(mFormGalpal10.getJumlah()));
        mJumlahEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setJumlah(convertToInt(s.toString()));
            }
        ...
        mKondisiEditText.setText(mFormGalpal10.getKondisi());
        mKondisiEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setKondisi(s.toString());
            }
        ...
        mLokasiEditText.setText(mFormGalpal10.getLokasi());
        mLokasiEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setLokasi(s.toString());
            }
        ...
        mStatusEditText.setText(mFormGalpal10.getStatus());
        mStatusEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setStatus(s.toString());
            }
        ...
        mKapasitasTerpakaiEditText.setText(String.valueOf(mFormGalpal10.getKapasitasTerpakai()));
        mKapasitasTerpakaiEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mFormGalpal10.setKapasitasTerpakai(convertToInt(s.toString()));
            }
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DummyMaker.get(getActivity()).addFormGalpal10(mFormGalpal10);
                getActivity().finish();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        setViewNote(mKualifikasiSurvey,mFormGalpal10);
    }
